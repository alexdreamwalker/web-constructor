#ifndef HORIZONTALFACTORY_CC
#define HORIZONTALFACTORY_CC

#include "../factory.cc"
#include "horizontalsunblind.cc"

class HorizontalFactory: public Factory
{
public:
    HorizontalFactory() {};
    ...
    virtual Construction* fromJSON(std::string data)
    {
        ...
        Sunblind *sunblind = new HorizontalSunblind(width, height);
        ...
        for(int i = 0; i < layers.size(); i++)
        {
            ...
            Layer* layer = new HorizontalLayer(layerWidth, layerHeight, minLayerSquare);
