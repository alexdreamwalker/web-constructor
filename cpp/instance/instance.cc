...
namespace {
  ...
  const char* const kReplyString = "hello back, bro!";
}
...
class ConstructorInstance : public pp::Instance {
 public:
  ...
  explicit ConstructorInstance(PP_Instance instance) : pp::Instance(instance)
  {}
...
class ConstructorModule : public pp::Module {
 public:
  ...
  virtual pp::Instance* CreateInstance(PP_Instance instance) {
    return new ConstructorInstance(instance);
  }
};
