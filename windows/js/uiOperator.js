...
function UIOperator(options) {
	...
	this.loadModule = function(options) {
		...
		this.loadWindow("mainWindow", "pages/mainWindow.html", function() {
			...
			uiOperator.loadWindow("moduleCategories", "pages/modules/" + module + "/categories.html", function() {
				uiOperator.loadWindow("moduleTable", "pages/modules/" + module + "/table.html", function() {
					uiOperator.loadWindow("moduleSummary", "pages/modules/" + module + "/summary.html", function() {
						...
						uiOperator.loadWindow("moduleModal", "pages/modules/" + module + "/modal.html", function() {
							uiOperator.loadWindow("moduleCanvas", "pages/modules/" + module + "/canvas.html", function() {
								uiOperator.loadWindow("moduleEmbed", "pages/modules/" + module + "/embed.html", function() {
									switch(module) {
										case "multiwindows": self.loadMultiWindows();							
										default: break;
									}
								});
							});
	...
	this.loadMultiWindows = function(options) {
		global.ui = new MultiWindowsUI({elem: "moduleCanvas", categories: "moduleCategories", table: "moduleTable", summary: "moduleSummary"});
		global.ui.start();
	};
